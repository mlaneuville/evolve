...
configs:
	python generate_initial_conditions.py -f paper/runs/init -n 4 -m man-ox -v 0.20

runs:
	python run_multi_config.py -f paper/runs/init

figs:
	python processing/generate_single_plot.py paper/runs/init/*.txt -c Atmosphere0 -e -o paper/figs/FIG3A.eps -n '(a)'
